  ...
  return (
    <>
      <a
        ...
        className="rounded-xl border border-white/10 bg-white/5 px-3 py-2.5 text-sm font-semibold text-zinc-200 hover:bg-white/10 flex items-center justify-center gap-1.5"
