...
const PHASES: Phase[] = [
  {
    ...
    items: [
      ...
      { title: "Creator monetization", detail: "Tips, membership tiers, Stripe buy packs, creator cash-out", status: "done" },
    ],
  },
  {
    label: "Phase 2 — Creator tools",
    period: "Q3 2026",
    items: [
      ...
      { title: "VOD replay pipeline", detail: "Automatic remux, HLS replays, member early access", status: "done" },
    ],
  },
  {
