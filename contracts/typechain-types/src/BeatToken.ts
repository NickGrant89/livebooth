...
export interface BeatTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_FAUCET"
      | "allowance"
...
export interface BeatToken extends BaseContract {
  connect(runner?: ContractRunner | null): BeatToken;
  waitForDeployment(): Promise<this>;

  interface: BeatTokenInterface;
  ...
  lastFaucetAt: TypedContractMethod<[arg0: AddressLike], [bigint], "view">;
