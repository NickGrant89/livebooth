...
export interface DropTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_FAUCET"
      | "MAX_SUPPLY"
...
export interface DropToken extends BaseContract {
  connect(runner?: ContractRunner | null): DropToken;
  waitForDeployment(): Promise<this>;

  interface: DropTokenInterface;
